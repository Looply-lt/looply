...
(function (global) {
    ...
    const KNOWLEDGE_BASE = [
        ...
        // --- Paslaugos --------------------------------------------------
        {
            ...
            answer: "Mes automatizuojame šešias pagrindines sritis: Gmail/el. pašto automatizaciją, išmanius AI chat botus svetainei, lead'ų (užklausų) apdorojimą, soc. medijų (Facebook, Instagram) turinio automatizaciją, sąskaitų ir mokėjimų automatizaciją bei individualią, jūsų įmonės poreikiams pritaikytą automatizaciją. Norite plačiau apie kurią nors iš šių sričių?"
        },
        {
            id: "gmail",
            keywords: ["gmail", "el pastas automatizacija", "laiskai", "pastas"],
            answer: "Gautas laiškas automatiškai nuskaitomas, o dirbtinis intelektas sugeneruoja atsakymą ir atpažįsta kliento duomenis. Sistema patikrina, ar klientas jau yra duomenų bazėje - atnaujina esamą įrašą arba sukuria naują, tuomet automatiškai išsiunčia atsakymą ir pažymi laišką kaip apdorotą."
        },
        {
            id: "chatbotai",
        ...
        },
        {
            ...
            answer: "Automatiškai generuojame ir publikuojame AI/DI sukurtą turinį jūsų „Facebook“, „Instagram“ ir kituose soc. medijų profiliuose pagal iš anksto suplanuotą grafiką - be jokio rankinio kėlimo."
        },
        {
            id: "saskaitos",
            keywords: ["saskaitos", "mokejimai", "saskaitu apdorojimas", "gaunamos saskaitos", "saskaitu atpazinimas"],
            answer: "Gauti laiškai su sąskaitomis automatiškai atpažįstami - nesvarbu, ar sąskaita pridėta kaip dokumentas, įrašyta laiško tekste, ar pateikta nuoroda. Dirbtinis intelektas ištraukia visus reikiamus duomenis ir automatiškai įrašo juos į jūsų apskaitos suvestinę."
        },
        {
            id: "individuali-automatizacija",
            keywords: ["individuali automatizacija", "individualus sprendimas", "pritaikyta automatizacija", "sukurta pagal mano poreikius", "custom automatizacija", "unikalus sprendimas", "bus mano nuosava", "imones nuosava automatizacija"],
            answer: "Kuriame automatizaciją, pritaikytą būtent jūsų įmonės poreikiams - ji tampa visiškai jūsų nuosava, suprojektuota ir pagaminta individualiai jums, o ne pagal šabloną."
        },
        {
